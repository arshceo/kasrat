...
// Validate ../../src/app/api/authorize-deployment/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/authorize-deployment">> = Specific
  const handler = {} as typeof import("../../src/app/api/authorize-deployment/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
